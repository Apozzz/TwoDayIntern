...
public class WarehouseController {
    ...
    static final String BEFORE_PURCHASE_PRODUCT_LOG = "Attempting to purchase product {} from warehouse {} with quantity {}...";
    static final String AFTER_PURCHASE_PRODUCT_LOG = "Successfully purchased {} of product {} from warehouse {}.";
