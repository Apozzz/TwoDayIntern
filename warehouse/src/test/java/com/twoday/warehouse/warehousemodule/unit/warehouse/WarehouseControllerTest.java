package com.twoday.warehouse.warehousemodule.unit.warehouse;
...
import com.twoday.warehouse.warehousemodule.unit.configs.TestAuthConfig;
import com.twoday.warehouse.warehousemodule.warehouse.WarehouseController;
...
public class WarehouseControllerTest {
    ...
    public void testSaveWarehouse() throws Exception {
        Mockito.when(warehouseService.saveWarehouse(Mockito.any(WarehouseDto.class))).thenReturn(sampleWarehouseDto);
    ...
    public void testSaveWarehouseProduct() throws Exception {
        Long warehouseId = 1L;
        Mockito.when(productService.saveProductByWarehouseId(Mockito.any(Long.class), Mockito.any(ProductDto.class)))
    ...
    public void testPurchaseProduct() throws Exception {
        ...
        mockMvc.perform(
                MockMvcRequestBuilders.post("/v1/warehouses/%s/products/%s/purchase".formatted(warehouseId, productId))
